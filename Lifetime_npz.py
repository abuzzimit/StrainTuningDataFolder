...
def fit_lifetime_minimal_npz(filename="lifetime_sL20_us_.npz", tail_frac=0.15, skip_after_peak_bins=0):
    d = np.load(filename)
...
if __name__ == "__main__":
    fit_lifetime_minimal_npz("lifetime_sL20_us_.npz", tail_frac=0.15, skip_after_peak_bins=0)
